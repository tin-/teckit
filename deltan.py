# -*- coding: utf-8 -*-
# $Id: deltan.py | Rev 45  | 2021/01/25 07:14:53 tin_fpga $
...
#mfcb.mfc_oper()
#time.sleep(2)
zerof1 = dmm2.get_data() #dmm1.get_adata()
zerof2 = dmm3.get_data() #dmm1.get_bdata()
...
def get_dsample():
    ...
    s2a = dmm2.read_val()[1] #dmm1.get_bdata()
    s3a = dmm3.read_val()[1] #(s1a + s2a) / 2#dmm3.read_val()[1]
    s4a = dmm4.read_val()[1]
