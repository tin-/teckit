# -*- coding: utf-8 -*-
# $Id: deltan2.py | Rev 45  | 2021/01/25 07:14:53 tin_fpga $
...
#dmm2   = imp.load_source('k2182a', 'devices/k2182.py')                 # Load Keysight 3458A support
...
#dmm7   = imp.load_source('d1281', 'devices/d1281.py')                 # Load Keysight 3458A support
#dmmz   = imp.load_source('hp3458', 'devices/hp3458.py')                 # Load Keysight 3458A support
#dmm2 = dmm2.scpi_meter (19,0,"2182A")  # GPIB.
dmm1 = dmm1.scpi_meter (5,0,"34420A")  # GPIB.
#dmm2 = dmm2.dmm_meter (3,0,"3458A3")  # GPIB.
#dmm7 = dmm7.dat_meter (8,0,"1281")  # GPIB.
#dmmz = dmmz.dmm_meter (11,0,"3458A11")  # GPIB.
dmm1.set_dcv_nrange(0.01,1)                                                # 3458A function/range config
dmm1.set_dcv_nrange(0.1,2)                                                # 3458A function/range config
#dmm2.set_dcv_nrange(1,1)                                                # 3458A function/range config
#dmm2.set_dcv_nrange(1,2)                                                # 3458A function/range config
#dmmz.set_dcv_range(100e-3)                                                # 3458A function/range config
#dmm7.set_input("FRONT")
#dmm7.set_dcv_range(100e-3)                                                # 3458A function/range config
...
#mfcb.mfc_stby()
#mfcb.mfc_cmd("OUT %.6e A;OPER" % 0.1) #Neg
#time.sleep(3)
#mfc.mfc_cmd("RANGELCK ON")
#mfcb.mfc_cmd("RANGELCK ON")
#time.sleep(1)
mfc.mfc_cmd("OUT 0.01 A, 0 Hz")
mfc.mfc_cmd("RANGELCK ON")
...
#time.sleep(2)
#dmm7.set_input("FRONT")
zerof1 = dmm1.get_adata()
#dmm7.set_input("CH_A")
zerof2 = dmm1.get_bdata()
#dmm7.set_input("CH_B")
zerof3 = 0#dmm7.get_data()
zerof4 = 0#dmmz.get_data()
...
def get_dsample():
    ...
    s3a = 0#-dmm7.get_data()
    s4a = 0#-dmmz.get_data()
    print ("\033[40;2H S1A = %.8e V  " % s1a)
    print ("\033[41;2H S2A = %.8e V  " % s2a)
    print ("\033[42;2H S3A = %.8e V  " % s3a)
...
def delta_sample():
    ...
    return calc_resa, calc_resb, calc_resc, calc_resd, meas1a, meas1b, meas1c, meas2a, meas2b, meas2c,meas4a, meas4b, meas4c
