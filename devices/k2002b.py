# -*- coding: utf-8 -*-
# $Id: devices/k2002b.py | Rev 46  | 2021/09/24 20:26:29 tin_fpga $
...
class scpie_meter():
    ...
    def __init__(self,gpib,reflevel,name):
        self.gpib = gpib
	print "\033[7;5H \033[0;31mGPIB[\033[1m%2d\033[0;31m] : Keithley 2002\033[0;39m" % self.gpib
        if cfg.get('teckit', 'interface', 1) == 'gpib':
	    ...
	    print (self.gpib)
	    print (cfg.get('teckit', 'vxib_ip', 1))
