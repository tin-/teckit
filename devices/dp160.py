# -*- coding: utf-8 -*-
# $Id: devices/dp160.py | Rev 45  | 2021/01/25 07:14:53 tin_fpga $
...
class scanner():
    ...
    def __init__(self,gpib,reflevel,name):
        self.gpib = gpib
        print "\033[1;4H \033[0;33mGPIB[\033[1m%2d\033[0;31m] : DP 160\033[0;39m" % self.gpib
        if cfg.get('teckit', 'interface', 1) == 'gpib':
    ...
    def set_channel(self, port, number):
	self.inst.write("%c%02d\n" % (port, number))
	time.sleep(0.25)
